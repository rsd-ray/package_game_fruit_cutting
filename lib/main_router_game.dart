...
import 'presentation/game/game.dart';
import 'presentation/game_over/game_over.dart';
import 'presentation/game_pause/game_pause.dart';
import 'presentation/game_victory/game_victory.dart';
...
class MainRouterGame extends FlameGame with KeyboardEvents {
  ...
  MainRouterGame({ required this.setScore });
  final Random random = Random();
  late final RouterComponent router;
  late double maxVerticalVelocity;
  late bool _scoreStatus = false;
  ...
  final List<FruitModel> fruits = [
    ...
    FruitModel(image: AppImages.soup, isBomb: true),
    FruitModel(image: AppImages.meteor, isBomb: true),
  ];
