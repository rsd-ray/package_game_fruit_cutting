...
import '../../common/widgets/text/simple_center_text.dart';
      ...
      addAll([
        ...
        TutorialFruitsListComponent(
          ...
          fruits: [
            ...
            TutorialFruitComponent(text: 'Soup', imagePath: AppImages.soup, isLeft: false),
            TutorialFruitComponent(text: 'Meteorite', imagePath: AppImages.meteor, isLeft: false),
          ],
        )..position = Vector2(0, 50),
      ]);
